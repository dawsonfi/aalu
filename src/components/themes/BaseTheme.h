...
enum UIIcon { Folder, Text, Image, Book, File, Recent, Settings, Transfer, Library, Wifi, Hotspot, Bookmark, None };
...
class BaseTheme {
 public:
  ...
  virtual void drawStatusBar(GfxRenderer& renderer, const float bookProgress, const int currentPage,
                             ...
                             const int textYOffset = 0, const bool suppressClock = false) const;
